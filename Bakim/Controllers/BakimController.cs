...
namespace Bakim.Controllers
{
    ...
    public class BakimController : Controller
    {
        ...
        public async Task<IActionResult> WorkTasks()
        {
            ...
            var result = new WorkTaskViewModel() { User = user, WorkTasks = tasks, AllUsers = users, Dtos = dtos, SectionDto = sectionDto };
            return View(result);
        }
        ...
        public async Task<IActionResult> AddTask(WorkTask task)
        {
