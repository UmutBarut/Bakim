...
var FullCalendar = (function (e) {
      ...
      e: if ("function" == typeof x) {
        if (
          ...
          null != x.getDerivedStateFromProps &&
            ...
            f(d.__s, x.getDerivedStateFromProps(D, d.__s))),
          (h = d.props),
          (v = d.state),
          p)
        )
          ...
          if (
            (null == x.getDerivedStateFromProps &&
              ...
              d.componentWillReceiveProps(D, b),
            (!d.__e &&
              null != d.shouldComponentUpdate &&
              !1 === d.shouldComponentUpdate(D, d.__s, b)) ||
              t.__v === n.__v)
          ) {
            (d.props = D),
              (d.state = d.__s),
          ...
          null != d.componentWillUpdate && d.componentWillUpdate(D, d.__s, b),
        ...
        (d.context = b),
          ...
          T(e, Array.isArray(w) ? w : [w], t, n, r, o, a, s, l, u),
          (d.base = t.__e),
          (t.__h = null),
          d.__h.length && s.push(d),
          E && (d.__E = d.__ = null),
  ...
  var Te = /(top|left|right|bottom|width|height)$/i;
  function we(e, t) {
  ...
  function Ue(e) {
    e.classList.remove("fc-unselectable"),
      e.removeEventListener("selectstart", Re);
  }
  function We(e) {
  ...
  function xt(e, t, n) {
    ...
    a)) {
      ...
      if (u.recurringDef) {
        ...
        for (
          var d = 0, p = Ct(u, c, t, r, o.recurringTypes);
          d < p.length;
          d++
        ) {
          var f = p[d],
  ...
  var kt = ["years", "months", "days", "milliseconds"],
  ...
  function At(e, t) {
    for (var n = null, r = 0; r < kt.length; r += 1) {
      var o = kt[r];
      if (t[o]) {
        var i = e[o] / t[o];
  ...
  var on = {
      ...
      buttonIcons: hn,
      customButtons: hn,
      defaultAllDayEventDuration: _t,
      defaultTimedEventDuration: _t,
      nextDayThreshold: _t,
      scrollTime: _t,
  ...
  var kn = { id: String, groupId: String, title: String, url: String },
    Rn = { start: hn, end: hn, date: hn, allDay: Boolean },
    _n = r(r(r({}, kn), Rn), { extendedProps: hn });
  ...
  function In(e) {
    return r(r(r({}, bn), _n), e.pluginHooks.eventRefiners);
  }
  ...
  function An(e, t) {
    ...
    return (
      e.start && ((n = ot(e.start)), r && r <= n && (r = Je(n, 1))),
      { start: n, end: r }
    );
  }
  function On(e) {
  ...
  function Ln(e, t, n, r) {
    return "year" === r
      ? _t(n.diffWholeYears(e, t), "year")
      : "month" === r
      ? _t(n.diffWholeMonths(e, t), "month")
      : tt(e, t);
  }
  function Un(e, t) {
    var n,
  ...
  function Gn(e, t, n, r) {
    var o = {},
      ...
      u = Xn(e.defs, t);
    for (var c in e.defs) {
      "inverse-background" === (f = u[(D = e.defs[c]).defId]).display &&
        (D.groupId
    ...
    for (var d in e.instances) {
      var p = e.instances[d],
        f = u[(D = e.defs[p.defId]).defId],
        h = p.range,
        v = !D.allDay && r ? An(h, r) : h,
        g = zn(v, n);
      g &&
    ...
    for (var c in i)
      for (var b = 0, T = Un(i[c], n); b < T.length; b++) {
        S = T[b];
        s.push({
          def: e.defs[c],
          ui: u[c],
  ...
  function nr(e, t, n, r, o, i, a) {
    ...
    var f = p.range.start,
      ...
      y = ot($e(h, -1)).valueOf() === ot($e(g, -1)).valueOf();
      ...
      return (
        ...
        (e.prototype.addEvent = function (e, t) {
          ...
          if (s) {
            ...
            return (
              this.dispatch({ type: "ADD_EVENTS", eventStore: gn(s) }),
      ...
      return (
        (e.prototype.setProp = function (e, t) {
          ...
          if (e in Rn)
            ...
            (t = kn[e](t)), this.mutate({ standardProps: { publicId: t } });
          else if (e in kn)
            (t = kn[e](t)),
        ...
        (e.prototype.setStart = function (e, t) {
          ...
          var n = this._context.dateEnv,
            r = n.createMarker(e);
          if (r && this._instance) {
            var o = Ln(this._instance.range.start, r, n, t.granularity);
            t.maintainDuration
        ...
        (e.prototype.setEnd = function (e, t) {
          ...
          if ((null == e || (n = r.createMarker(e))) && this._instance)
            if (n) {
              var o = Ln(this._instance.range.end, n, r, t.granularity);
        ...
        (e.prototype.setDates = function (e, t, n) {
          ...
          if (l && (null == t || (r = a.createMarker(t))) && this._instance) {
            ...
            if (r) {
              var d = Ln(u.end, r, a, n.granularity);
              (i = d),
                (o = c).years === i.years &&
                o.months === i.months &&
                o.days === i.days &&
  ...
  var Ir = (function () {
      ...
      return (
        ...
        (e.prototype.diffWholeMonths = function (e, t) {
          var n = this.calendarSystem;
          return pt(e) === pt(t) && n.getMarkerDay(e) === n.getMarkerDay(t)
            ? n.getMarkerMonth(t) -
                n.getMarkerMonth(e) +
        ...
        (e.prototype.toDate = function (e, t) {
          return "local" === this.timeZone
            ...
            ? new Date(
                e.valueOf() -
                  1e3 * this.namedTimeZoneImpl.offsetForArray(ut(e)) * 60
              )
      ...
      return (
        (e.prototype.splitProps = function (e) {
          ...
          for (var c in ((this.eventUiBuilders = mt(n, function (e, n) {
            return t.eventUiBuilders[n] || Ft(Kr);
          })),
          n)) {
            var d = n[c],
              p = a[c] || Zr,
  ...
  var mo = FullCalendarVDom.Component,
    ...
    Do = FullCalendarVDom.createRef,
    So = FullCalendarVDom.Fragment,
    bo = FullCalendarVDom.createContext,
    To = FullCalendarVDom.createPortal,
    wo = FullCalendarVDom.flushToDom,
    xo = FullCalendarVDom.unmountComponentAtNode,
    Co = (function () {
      function e(e, t, n, o) {
        var i = this;
        (this.execFunc = e),
    ...
    ko = bo({});
  function Ro(e, t, n, r, o, i, a, s, l, u, c, d, p) {
    return {
      dateEnv: o,
      options: n,
      pluginHooks: a,
      ...
      createScrollResponder: function (e) {
        return new Co(e, u, _t(n.scrollTime), n.scrollTimeReset);
      },
  ...
  (_o.prototype.propEquality = {}), (_o.prototype.stateEquality = {});
  var Mo = (function (e) {
    function t() {
      return (null !== e && e.apply(this, arguments)) || this;
    }
    return n(t, e), (t.contextType = ko), t;
  })(_o);
  function Po(e) {
    ...
    return (
      ...
      (t.prototype.isValidSegDownEl = function (e) {
        return (
          ...
          !De(e, ".fc-event-mirror")
        );
      }),
      (t.prototype.isValidDateDownEl = function (e) {
        return !(
          De(e, ".fc-event:not(.fc-bg-event)") ||
          De(e, ".fc-more-link") ||
          De(e, "a[data-navlink]") ||
          De(e, ".fc-popover")
        );
  ...
  (Lo.prototype.classes = {
    ...
    (Lo.prototype.baseIconClass = "fc-icon"),
    (Lo.prototype.iconClasses = {
      close: "fc-icon-x",
    ...
    (Lo.prototype.iconOverrideOption = "buttonIcons"),
    (Lo.prototype.iconOverrideCustomButtonOption = "icon"),
    (Lo.prototype.iconOverridePrefix = "fc-icon-");
  var Wo = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
    ...
    zo = bo(0);
  function Vo(e) {
    return yo(zo.Consumer, null, function (t) {
      return yo(Fo, r({ renderId: t }, e));
    });
  }
  var Fo = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.innerElRef = Do()), t;
      }
      return (
        n(t, e),
        (t.prototype.render = function () {
  ...
  function jo() {
    ...
    return function (r, o) {
      return (
        (t && Dt(t, o) && r === e) || ((e = r), (t = o), (n = Go(r, o))), n
      );
    };
  }
  function Go(e, t) {
  ...
  function Xo(e) {
    ...
    return (
      n.content &&
        ((t = n),
        (o = function (e) {
          return yo(ko.Consumer, null, function (n) {
  ...
  var $o = (function () {
    ...
    return (
      ...
      (e.prototype.adjustActiveRange = function (e) {
        ...
        return (
          r &&
            ...
            Nt(i) > 1 && ((s = Je((s = ot(s)), -1)), (s = n.add(s, i)))),
          { start: a, end: s }
        );
      }),
      ...
      (e.prototype.buildRangeFromDayCount = function (e, t, n) {
        ...
        do {
          (r = Je(r, 1)), this.isHiddenDay(r) || (s += 1);
        } while (s < n);
      ...
      (e.prototype.buildDateIncrement = function (e) {
        ...
        return (
          n ||
          ((t = this.props.dateAlignment) ? _t(1, t) : e || _t({ days: 1 }))
        );
      }),
      ...
      case "RECEIVE_EVENTS":
        return (function (e, t, n, r, o, i) {
          if (t && n === t.latestFetchId) {
            ...
            return r && (a = xt(a, r, i)), En(ci(e, t.sourceId), a);
          }
          return e;
    ...
    Ao({
      ...
      propSetHandlers: {
        dateProfile: function (e, t) {
          t.emitter.trigger(
            "datesSet",
            r(r({}, ur(e.activeRange, t.dateEnv)), { view: t.viewApi })
          );
        },
    ...
    wi = (function () {
      function e(e, t) {
        (this.runTaskOption = e),
          ...
          (this.queue = []),
          (this.delayedRunner = new Ti(this.drain.bind(this)));
      }
      return (
  ...
  var Ci = (function () {
    function e(e) {
      ...
      (this.computeOptionsData = Ft(this._computeOptionsData)),
        ...
        (this.organizeRawLocales = Ft(Ar)),
        (this.buildLocale = Ft(Or)),
        (this.buildPluginHooks = Oo()),
        (this.buildDateEnv = Ft(ki)),
        (this.buildTheme = Ft(Ri)),
        (this.parseToolbars = Ft(vi)),
        (this.buildViewSpecs = Ft(Ko)),
        (this.buildDateProfileGenerator = Bt(_i)),
        (this.buildViewApi = Ft(Mi)),
        (this.buildViewUiProps = Bt(Ni)),
        (this.buildEventUiBySource = Ft(Pi, Dt)),
        (this.buildEventUiBases = Ft(Ii)),
        (this.parseContextBusinessHours = Bt(Ai)),
        (this.buildTitle = Ft(xi)),
        (this.emitter = new co()),
      ...
      var s,
        ...
        c =
          ((s = o.calendarOptions),
          (l = o.dateEnv),
          null != (u = s.initialDate) ? l.createMarker(u) : br(s.now, l)),
    ...
    return (
      ...
      (e.prototype._handleAction = function (e) {
        ...
        this.data &&
          ...
          ("PREV" !== e.type && "NEXT" !== e.type && jn(p.currentRange, d)) ||
      ...
      (e.prototype.processRawCalendarOptions = function (e, t) {
        var n = pn([an, e, t]),
          ...
          u = this.buildPluginHooks(e.plugins || [], Di),
    ...
    Wi = (function () {
      ...
      return (
        ...
        (e.prototype.findInsertion = function (e) {
          ...
          var D = -1;
          return (
            E < a && n[E] === s && (D = qi(r[E], e.span.end, zi)[0]),
            {
              touchingLevel: l,
              touchingLateral: u,
              touchingEntry: c,
  ...
  var Ki = {},
    ...
    $i = {},
    Qi = { startTime: _t, duration: _t, create: Boolean, sourceId: String };
  function ea(e) {
    var t = fn(e, Qi),
      n = t.refined,
      r = t.extra;
  ...
  var ta = (function (e) {
      ...
      return (
        ...
        (t.prototype.renderWidgetGroup = function (e) {
          for (
            ...
            if ("title" === c)
              (a = !1),
                i.push(yo("h2", { className: "fc-toolbar-title" }, t.title));
            else {
        ...
        return (
          (n.handleSegClick = function (e, t) {
            ...
            if (i && r.isValidSegDownEl(e.target)) {
              var a = De(e.target, ".fc-event-forced-url"),
    ...
    aa = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.buildViewContext = Ft(Ro)),
          (t.buildViewPropTransformers = Ft(la)),
          (t.buildToolbarProps = Ft(sa)),
          (t.handleNavLinkClick = _e(
            "a[data-navlink]",
          ...
          (t.resizeRunner = new Ti(function () {
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this.props,
            ...
            u = [da].concat($r(l, o), e.extraClassNames || []),
  ...
  function ga(e) {
    var t = ot(e);
    return { start: t, end: Je(t, 1) };
  }
  var ma = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (t.createDayHeaderFormatter = Ft(ya)), t;
    }
    return (
      n(t, e),
      (t.prototype.render = function () {
      ...
      return (
        (e.prototype.sliceRange = function (e) {
          var t = this.getDateDayIndex(e.start),
            n = this.getDateDayIndex(Je(e.end, -1)),
            r = Math.max(0, t),
      ...
      return (
        ...
        (e.prototype.sliceEventRange = function (e, t) {
          ...
          this.forceDayIfListItem &&
            ...
            (n = { start: n.start, end: Je(n.start, 1) });
          for (
  ...
  function Ta(e, t, n) {
    ...
    return xa({ eventDrag: e }, n);
  }
  function wa(e, t, n) {
    return !!Bn(t.validRange, e.range) && xa({ dateSelection: e }, n);
  }
  function xa(e, t) {
      ...
      !(
        ...
        !(function (e, t, n, o) {
          ...
          for (var m in u) {
            var y = u[m],
              ...
              D = c[y.defId],
              S = l[y.defId];
            if (!ka(D.constraints, E, d, e.businessHours, t)) return !1;
            var b = t.options.eventOverlap,
              T = "function" == typeof b ? b : null;
            for (var w in f) {
              var x = f[w];
              if (Fn(E, x.range)) {
                if (!1 === h[x.defId].overlap && a.isEvent) return !1;
                if (!1 === D.overlap) return !1;
                if (T && !T(new wr(t, p[x.defId], x), new wr(t, S, y)))
                  return !1;
              }
            }
            for (var C = i.eventStore, k = 0, R = D.allows; k < R.length; k++) {
              var _ = R[k],
                M = r(r({}, n), { range: y.range, allDay: S.allDay }),
                P = C.defs[S.defId],
                I = C.instances[m],
                N = void 0;
              if (((N = P ? new wr(t, P, I) : new wr(t, S)), !_(fr(M, t), N)))
                return !1;
            }
          }
          return !0;
        ...
        !(
          ...
          !(function (e, t, n, o) {
            ...
            o && (c = o(c));
            if (!ka(c.constraints, u, i, e.businessHours, t)) return !1;
  ...
  function ka(e, t, n, r, o) {
    for (var i = 0, a = e; i < a.length; i++) {
      if (!Ma(Ra(a[i], t, n, r, o), t)) return !1;
    }
    return !0;
  }
    ...
    return (
      ...
      (t.prototype.renderSection = function (e, t) {
        return "outerContent" in e
          ? yo(So, { key: e.key }, e.outerContent)
          : yo(
              "tr",
              { key: e.key, className: Ba(e, this.props.liquid).join(" ") },
      ...
      (t.prototype.computeShrinkWidth = function () {
        return Va(this.props.cols) ? Ha(this.scrollerElRefs.getAll()) : 0;
      }),
  ...
  Ya.addStateEquality({ scrollerClientWidths: Dt, scrollerClientHeights: Dt });
  var Za = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.elRef = Do()), t;
    ...
    return yo(
      ...
      yo(
        ...
        yo(
          ...
          e.event.title || yo(So, null, " ")
        )
      )
    );
  }
  var Ja = function (e) {
      return yo(ko.Consumer, null, function (t) {
        var n = t.options,
          r = {
            isAxis: e.isAxis,
  ...
  function es(e) {
    var t = e.date,
      n = e.dateEnv,
      o = Jr(t, e.todayRange, null, e.dateProfile);
    return r(
  ...
  function os(e) {
    return (
      e.event.title && yo("div", { className: "fc-event-title" }, e.event.title)
    );
  }
  var is = function (e) {
    return yo(ko.Consumer, null, function (t) {
        ...
        (t.prototype.updateSize = function () {
          ...
          if (i) {
            var a = o.getBoundingClientRect(),
              s = r
                ? De(n, ".fc-scrollgrid").getBoundingClientRect().top
                : i.top,
      ...
      return (
        ...
        (t.prototype.updateParentEl = function () {
          this.linkElRef.current &&
            (this.parentEl = De(this.linkElRef.current, ".fc-view-harness"));
        }),
        t
      );
    })(Mo);
  ...
  function ds(e) {
    if (e.allDayDate) return { start: e.allDayDate, end: Je(e.allDayDate, 1) };
    var t,
      n = e.hiddenSegs;
  ...
  var vs = (function (e) {
    function t(t, n) {
      ...
      return (
                ...
                function (t, n, i, a) {
                  return (
                    ...
                    yo(
                      ...
                      yo(aa, r({ isHeightAuto: i, forPrint: a }, e))
                    )
                  );
                }
              ),
        ...
        (o.el = t),
        (o.renderRunner = new Ti(o.handleRenderRequest)),
        new Ci({
          optionOverrides: n,
          calendarApi: o,
    ...
    Es = (function () {
      function e(e) {
        ...
        (this.subjectEl = null),
          ...
          1 === (ms += 1) &&
            window.addEventListener("touchmove", Ds, { passive: !1 });
      }
      return (
        (e.prototype.destroy = function () {
          this.containerEl.removeEventListener(
            ...
            (ms -= 1) ||
              window.removeEventListener("touchmove", Ds, { passive: !1 });
        }),
        (e.prototype.tryStart = function (e) {
          var t = this.querySubjectEl(e),
            n = e.target;
          return (
            !(!t || (this.handleSelector && !De(n, this.handleSelector))) &&
            ((this.subjectEl = t),
            (this.isDragging = !0),
            (this.wasTouchScroll = !1),
            !0)
        ...
        (e.prototype.querySubjectEl = function (e) {
          return this.selector ? De(e.target, this.selector) : this.containerEl;
        }),
  ...
  var Ss = (function () {
    ...
    xs = "function" == typeof performance ? performance.now : Date.now,
    Cs = (function () {
      function e() {
        var e = this;
        (this.isEnabled = !0),
      ...
      return (
        ...
        (e.prototype.handleMove = function (e, t) {
          if (this.isEnabled) {
            ...
            o < 0
              ...
              this.isAnimating ||
                ((this.isAnimating = !0), this.requestAnimation(xs()));
          }
        }),
        ...
        (e.prototype.buildCaches = function (e) {
          return this.queryScrollEls(e).map(function (e) {
            return e === window ? new ws(!1) : new Ts(e, !1);
          });
        }),
  ...
  function Ms(e, t) {
    return (
      (!e && !t) || (Boolean(e) === Boolean(t) && lr(e.dateSpan, t.dateSpan))
    );
  }
  function Ps(e, t) {
    for (
  ...
  var Is = (function (e) {
      function t(t) {
        ...
        var o = (n.hitDragging = new _s(n.dragging, Xi(t)));
        return (
    ...
    Ns = (function (e) {
      function t(t) {
        ...
        var a = (n.hitDragging = new _s(n.dragging, Xi(t)));
        return (
  ...
  var Hs = (function (e) {
    function t(n) {
        ...
        (o.handlePointerDown = function (e) {
          ...
          (o.relevantEvents = mn(l.getCurrentData().eventStore, c)),
            ...
            s.fixedMirrorParent
              ...
              : (a.parentNode = De(t, ".fc")),
            (a.revertDuration = s.dragRevertDuration);
          var d = r.isValidSegDownEl(t) && !De(t, ".fc-event-resizer");
          i.setIgnoreMove(!d),
            (o.isDragging =
            ...
            if (e) {
              ...
              i === a || (d.editable && d.droppable)
                ? (s = (function (e, t, n) {
                  ...
                  ((l = vr(n, a.getCurrentData().eventUiBases, s, a)),
                  (c.mutatedEvents = l),
                  Ta(c, e.dateProfile, a) ||
                    ((u = !0),
                    (s = null),
                    (l = null),
          ...
          if (o.isDragging) {
            ...
            if (
              ...
              if (a === t) {
                ...
                t.emitter.trigger(
                  "eventLeave",
                  r(r({}, D), { draggedEl: e.subjectEl, view: n })
                ),
      ...
      var s = (o.hitDragging = new _s(o.dragging, Ki));
      return (
  ...
  var As = (function (e) {
        ...
        (n.handleDragEnd = function (e) {
          ...
          if (
            ...
            t.emitter.trigger(
              ...
              r(r({}, c), {
                el: n.draggingSegEl,
                startDelta: n.validMutation.startDelta || _t(0),
                endDelta: n.validMutation.endDelta || _t(0),
                jsEvent: e.origEvent,
                view: t.viewApi,
              })
            ),
    ...
    return (
      ...
      (t.prototype.querySegEl = function (e) {
        return De(e.subjectEl, ".fc-event");
      }),
      t
    );
  })(Yi);
  var Os = (function () {
        ...
        (this.context = e),
          ...
          (this.onDocumentPointerDown = function (e) {
            var n = t.context.options.unselectCancel,
              r = Ce(e.origEvent);
            (t.matchesCancel = !!De(r, n)),
              (t.matchesEvent = !!De(r, Hs.SELECTOR));
          }),
    ...
    Ws = (function () {
      function e(e, t) {
        ...
        var o = (this.hitDragging = new _s(e, Ki));
        (o.requireInitial = !1),
  ...
  var zs = (function () {
        ...
        void 0 === t && (t = {}),
          (this.handlePointerDown = function (e) {
            var t = n.dragging,
              ...
              i = r.longPressDelay;
            (t.minDistance =
              null != o ? o : e.isTouch ? 0 : an.eventDragMinDistance),
              (t.delay = e.isTouch ? (null != i ? i : an.longPressDelay) : 0);
          }),
          (this.handleDragStart = function (e) {
            e.isTouch &&
              n.dragging.delay &&
    ...
    Bs = Ao({
      componentInteractions: [Is, Ns, Hs, As],
  ...
  function al(e, t, n, o) {
    ...
    var i = e.eventRange,
      a = i.range,
      s = zn(a, { start: o[t].date, end: Je(o[n - 1].date, 1) });
    return r(r({}, e), {
      firstCol: t,
      lastCol: n - 1,
      eventRange: {
          ...
          if (this.hiddenConsumes && s) {
            ...
            if (!a[c])
              if (this.allowReslicing) {
                ...
                (a[Vi(d)] = !0), (i[l][u] = d), this.splitEntry(s, n, o);
              } else (a[c] = !0), o.push(s);
          }
          ...
          return yo(
            ...
            n.cells.map(function (t, r) {
              ...
              return yo(ol, {
                ...
                fgContent: yo(So, null, yo(So, null, o), yo(So, null, i)),
                bgContent: yo(
                  So,
                  null,
        ...
        (t.prototype.renderFgSegs = function (e, t, n, o, i, a, s) {
          ...
          if (c)
            for (var h = 0, v = t; h < v.length; h++) {
              ...
              S &&
                (l.isRtl
                  ? ((T = 0), (b = c.lefts[m.lastCol] - c.lefts[m.firstCol]))
                  : ((b = 0),
                    (T = c.rights[m.firstCol] - c.rights[m.lastCol]))),
                f.push(
                  yo(
                    "div",
                    {
  ...
  ll.addStateEquality({ eventInstanceHeights: Dt });
  var ul = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (
        (t.splitBusinessHourSegs = Ft(Gs)),
        (t.splitBgEventSegs = Ft(Gs)),
        (t.splitFgEventSegs = Ft(Gs)),
        (t.splitDateSelectionSegs = Ft(Gs)),
        (t.splitEventDrag = Ft(Ys)),
        (t.splitEventResize = Ft(Ys)),
        (t.rowRefs = new Na()),
        (t.handleRootEl = function (e) {
          (t.rootEl = e),
            e
  ...
  var dl = (function (e) {
    ...
    pl = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.slicer = new dl()), (t.tableRef = Do()), t;
      }
      return (
        n(t, e),
        (t.prototype.render = function () {
  ...
  function hl(e, t) {
    ...
    return new Da(n, /year|month|week/.test(e.currentRangeUnit));
  }
  var vl = Ao({
  ...
  function yl(e) {
    ...
    return yo(ko.Consumer, null, function (n) {
      if (!e.isLabeled)
        return yo("td", { className: t.join(" "), "data-time": e.isoTimeStr });
      var r = n.dateEnv,
        o = n.options,
        i = n.viewApi,
        a =
        ...
        return (
          ...
          (t.renderHeadAxis = function (e, n) {
            ...
            var o = t.context.options,
              ...
              s =
                o.navLinks && 1 === a
                  ? { "data-navlink": Qr(i.start, "week"), tabIndex: 0 }
                  : {};
                  ...
                  content: function (e) {
                    return yo(
                      ...
                      yo(
                        ...
                        e.tableColGroupNode,
                        yo("tbody", null, yo(Dl, { slatMetas: i }))
                      ),
                      yo(
                        "div",
  ...
  var wl = (function () {
        ...
        (e.prototype.safeComputeTop = function (e) {
          ...
          if (jn(t.currentRange, e)) {
            ...
            if (r >= Ht(t.slotMinTime) && r < Ht(t.slotMaxTime))
              return this.computeTimeTop(_t(r));
          }
          return null;
        }),
        (e.prototype.computeDateTop = function (e, t) {
          return (
            t || (t = ot(e)), this.computeTimeTop(_t(e.valueOf() - t.valueOf()))
          );
        }),
    ...
    Cl = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.rootElRef = Do()), (t.slatElRefs = new Na()), t;
      }
      return (
        n(t, e),
        (t.prototype.render = function () {
  ...
  var Ll = rn({ hour: "numeric", minute: "2-digit", meridiem: !1 }),
    Ul = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
      }
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return yo(
            ...
            function (e, t) {
              return (
                t && yo("div", { className: "fc-timegrid-col-misc", ref: e }, t)
              );
            }
          );
        }),
    ...
    zl = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.sortEventSegs = Ft(Jn)), t;
      }
      return (
        n(t, e),
        (t.prototype.render = function () {
            ...
            i = Ol(e, n.date, n.slatCoords, o.options.eventMinHeight).map(
              function (o, i) {
                ...
                return yo(
                  ...
                  "bg-event" === t
                    ? yo(rs, r({ seg: a }, rr(a, n.todayRange, n.nowDate)))
                    : ns(t)
                );
              }
            );
  ...
  var Bl = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (
        (t.splitFgEventSegs = Ft(kl)),
        (t.splitBgEventSegs = Ft(kl)),
        (t.splitBusinessHourSegs = Ft(kl)),
        (t.splitNowIndicatorSegs = Ft(kl)),
        (t.splitDateSelectionSegs = Ft(kl)),
      ...
      (t.prototype.queryHit = function (e, t) {
        ...
        if (null != p && null != f) {
          var h = this.props.cells[p],
            ...
            D = Pt(s.slotMinTime, It(c, y)),
            S = o.add(E, D),
            b = o.add(S, c);
          return {
            dateProfile: s,
            dateSpan: r(
              { range: { start: S, end: b }, allDay: !1 },
              h.extraDateSpan
            ),
            dayEl: a.els[p],
            rect: {
        ...
        l =
          ...
          (function (e) {
            ...
            for (t = Xl.length - 1; t >= 0; t -= 1)
              if (null !== (r = At((n = _t(Xl[t])), e)) && r > 1) return n;
            return e;
          })(r),
        u = [];
      Ht(a) < Ht(t);
  ...
  var Jl = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (t.buildTimeColsModel = Ft($l)), (t.buildSlatMetas = Ft(Kl)), t;
    }
    return (
      n(t, e),
      (t.prototype.render = function () {
  ...
  function tu(e) {
    ...
    return yo(
      ...
      e.sideText &&
        yo("a", r({ className: "fc-list-day-side-text" }, t), e.sideText)
    );
  }
  ...
  function lu(e) {
    for (
      var t = ot(e.renderRange.start), n = e.renderRange.end, r = [], o = [];
      t < n;

    )
      r.push(t), o.push({ start: t, end: Je(t, 1) }), (t = Je(t, 1));
  ...
  var pu = Ao({ themeClasses: { bootstrap: du } }),
            ...
            var u = (function (e) {
              ...
              p = (function (e, t, n, o) {
                ...
                o.canComputeOffset
                  ...
                  : ((a = Je(e.start, -1).toISOString()),
                    (s = Je(e.end, 1).toISOString()));
                (i = r(r({}, n || {}), {
                  key: t,
                  timeMin: a,
                  timeMax: s,
  ...
  return (
    ...
    (e.DayTimeColsView = Jl),
    (e.DelayedRunner = Ti),
    (e.Draggable = zs),
    (e.ElementDragging = Ji),
    ...
    (e.unmountComponentAtNode = xo),
    (e.unpromisify = uo),
    (e.version = "5.9.0"),
    (e.whenTransitionDone = Ie),
    (e.wholeDivideDurations = At),
